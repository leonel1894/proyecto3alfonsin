function solicitudEmpanadas() {
    ...
    for (let i = 1; i <= 3; i++) {
        ...
        if (cantidad >= 6 && cantidad <= 24) {
            ...
            alert("La cantidad ingresada no es correcta, por favor vuelva a realizar la operacion, minimo 6 y maximo 24 empanadas. Intentos" + " " + intento);
        }
    }
}
